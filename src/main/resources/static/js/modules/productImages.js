...
Storevo.ProductImages = {
    state: {
        ...
        existing: [],      // URLs de BD
        order: [],         // Mix de File names y URLs
        mainRef: null,
        draggedItem: null
    },
    ...
    init: function() {
        ...
        // Limpieza de estados corruptos si no hay mainRef
        ...
        // Eventos Drag & Drop de la zona de subida
        ...
        fileInput.addEventListener('change', (e) => {
            ...
            fileInput.value = ''; // Resetear para permitir subir el mismo archivo si se borró
        });

        // Interceptar Submit para sincronizar estado
    ...
    handleFiles: function(files) {
        ...
        if (remainingSlots <= 0) {
            if (Storevo.UI && Storevo.UI.Toast) Storevo.UI.Toast.show('Máximo 10 imágenes permitidas.', 'warning');
            return;
        }
    ...
    removeImage: function(ref) {
        ...
        // Reasignar Principal si se borró
    ...
    render: function() {
        ...
        this.state.order.forEach((ref, index) => {
            // Buscar si es existente o nueva
    ...
    syncHiddenInputs: function() {
        ...
        // 4. Inyectar archivos físicos reales usando DataTransfer (Magia HTML5)
